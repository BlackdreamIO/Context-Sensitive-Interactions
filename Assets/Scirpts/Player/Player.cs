...
namespace EL.Core.Player
{
    ...
    {   
        ...
        [Title("MOVEMENT", CustomColor.Cyan, CustomColor.White, 1f, 20f)]
        ...
        [Title("STAMINA", CustomColor.Aqua, CustomColor.BlueVariant, 1f, 20f)]
        ...
        [Title("INPUT", CustomColor.Yellow, CustomColor.White, 1f, 20f)]
